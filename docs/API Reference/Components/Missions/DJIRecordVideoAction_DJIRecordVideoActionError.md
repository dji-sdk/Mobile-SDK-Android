<div class="article"><h1 ><font color="#AAA">class </font>RecordVideoActionError</h1></div>

~~~java
 class RecordVideoActionError extends DJIError 
~~~
...
<font color="#666">Error codes for record video actions.
...
<div class="api-row" id="djirecordvideoaction_djirecordvideoactionerror_invalidduration"><div class="api-col left"></div><div class="api-col middle" style="color:#AAA">final</div><div class="api-col right"><a class="trigger" href="#djirecordvideoaction_djirecordvideoactionerror_invalidduration_inline">INVALID_DURATION</a></div></div><div class="inline-doc" id="djirecordvideoaction_djirecordvideoactionerror_invalidduration_inline"

><div class="article"><h6 ><font color="#AAA">final </font>INVALID_DURATION</h6></div>

~~~java
 static final RecordVideoActionError
        INVALID_DURATION = new RecordVideoActionError("Duration value is invalid which is less than 0")
~~~
...
<font color="#666">Duration value is invalid (less than 0).
