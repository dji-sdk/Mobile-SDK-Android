<div class="article"><h1 ><font color="#AAA">class </font>TimelineMission</h1></div>

~~~java
 class TimelineMission extends TimelineElement 
~~~

<html><table class="table-supportedby"><tr valign="top"><td width=15%><font color="#999"><i>Package:</i></td><td width=85%><font color="#999">dji.sdk.mission.timeline</td></tr><tr valign="top"><td width=15%><font color="#999"><i>Inherits From:</i></td><td width=85%><font color="#999"><code><a href="/Components/Missions/DJIMissionControlTimelineElement.html#djimissioncontroltimelineelement">TimelineElement</a></code></td></tr></table></html>
...
<font color="#666">Wrapper class for the different types of Mission to be compatible with Timeline.



##### Class Members:

<div class="api-row" id="timelinemission_elementfromwaypointmission"><div class="api-col left"></div><div class="api-col middle" style="color:#AAA">method</div><div class="api-col right"><a class="trigger" href="#timelinemission_elementfromwaypointmission_inline">elementFromWaypointMission</a></div></div><div class="inline-doc" id="timelinemission_elementfromwaypointmission_inline"

><div class="article"><h6 ><font color="#AAA">method </font>elementFromWaypointMission</h6></div>
...
<font color="#666">Create TimelineElement from a WaypointMission. This Element  then can be used in Timeline.



##### Input Parameters:

<html><table class="table-inline-parameters"><tr valign="top"><td><font color="#70BF41"><a href="/Components/Missions/DJIWaypointMission.html#djiwaypointmission">WaypointMission</a> <font color="#000">mission</td><td><font color="#666"><i>A <code><a href="/Components/Missions/DJIWaypointMission.html#djiwaypointmission">WaypointMission</a></code> object.</i></td></tr></table></html>

##### Return:

<html><table class="table-inline-parameters"><tr valign="top"><td><font color="#70BF41">static <a href="/Components/Missions/DJIMissionControlTimelineElement.html#djimissioncontroltimelineelement">TimelineElement</a></td><td><font color="#666"><i>A <code><a href="/Components/Missions/DJIMissionControlTimelineElement.html#djimissioncontroltimelineelement">TimelineElement</a></code> object.</i></td></tr></table></html></div>

<div class="api-row" id="timelinemission_getmissionobject"><div class="api-col left"></div><div class="api-col middle" style="color:#AAA">method</div><div class="api-col right"><a class="trigger" href="#timelinemission_getmissionobject_inline">getMissionObject</a></div></div><div class="inline-doc" id="timelinemission_getmissionobject_inline"

><div class="article"><h6 ><font color="#AAA">method </font>getMissionObject</h6></div>
...
<font color="#666">Get the Mission object that is being contained inside the wrapper class.



##### Return:

<html><table class="table-inline-parameters"><tr valign="top"><td><font color="#70BF41">Object</td><td><font color="#666"><i>Get the Mission object.</i></td></tr></table></html></div>
