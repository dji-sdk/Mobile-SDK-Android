<div class="article"><h1 ><font color="#AAA">class </font>DJIUpgradeError</h1></div>

~~~java
 class DJIUpgradeError extends DJIError 
~~~
...
<font color="#666">Errors related to the upgrade.
...
<div class="api-row" id="djierror_djiupgradeerror_inwifilink"><div class="api-col left"></div><div class="api-col middle" style="color:#AAA">final</div><div class="api-col right"><a class="trigger" href="#djierror_djiupgradeerror_inwifilink_inline">IN_WIFI_LINK</a></div></div><div class="inline-doc" id="djierror_djiupgradeerror_inwifilink_inline"

><div class="article"><h6 ><font color="#AAA">final </font>IN_WIFI_LINK</h6></div>

~~~java
 static final DJIUpgradeError IN_WIFI_LINK = new DJIUpgradeError("Cannot upgrade when using wifi link.")
~~~
...
<font color="#666">Cannot upgrade when using <code><a href="/Components/WiFiLink/DJIWiFiLink.html#djiwifilink">WiFiLink</a></code>.
