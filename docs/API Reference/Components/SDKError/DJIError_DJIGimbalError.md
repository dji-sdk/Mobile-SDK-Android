<div class="article"><h1 ><font color="#AAA">class </font>DJIGimbalError</h1></div>
...
<font color="#666">Defines all gimbal related errors.



##### Class Members:

<div class="api-row" id="djierror_djigimbalerror_getdjierror"><div class="api-col left"></div><div class="api-col middle" style="color:#AAA">method</div><div class="api-col right"><a class="trigger" href="#djierror_djigimbalerror_getdjierror_inline">getDJIError</a></div></div><div class="inline-doc" id="djierror_djigimbalerror_getdjierror_inline"
...
<font color="#666">Returns the specific error in DJIGimbalError according to the error code.
...
<div class="api-row" id="djierror_djigimbalerror_gimbal_result_failed"><div class="api-col left"></div><div class="api-col middle" style="color:#AAA">final</div><div class="api-col right"><a class="trigger" href="#djierror_djigimbalerror_gimbal_result_failed_inline">RESULT_FAILED</a></div></div><div class="inline-doc" id="djierror_djigimbalerror_gimbal_result_failed_inline"

><div class="article"><h6 ><font color="#AAA">final </font>RESULT_FAILED</h6></div>
...
<font color="#666">Gimbal Result Failed.

</div>

<div class="api-row" id="djierror_djigimbalerror_gimbal_cannot_set_parameters_in_this_state"><div class="api-col left"></div><div class="api-col middle" style="color:#AAA">final</div><div class="api-col right"><a class="trigger" href="#djierror_djigimbalerror_gimbal_cannot_set_parameters_in_this_state_inline">CANNOT_SET_PARAMETERS_IN_THIS_STATE</a></div></div><div class="inline-doc" id="djierror_djigimbalerror_gimbal_cannot_set_parameters_in_this_state_inline"
